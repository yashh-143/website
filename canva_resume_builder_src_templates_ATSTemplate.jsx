...
export const ATSTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden p-12 border-b-2 border-black">
    <div className="p-8">
