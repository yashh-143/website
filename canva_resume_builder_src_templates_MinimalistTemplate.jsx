...
export const MinimalistTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden font-light tracking-[0.2em] p-20">
    <div className="p-8">
