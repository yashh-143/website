...
export const ServiceTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden border-[16px] border-slate-100 p-8">
    <div className="p-8">
