...
export const BrutalistTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden bg-[#FFDE03] border-4 border-black p-8 font-black">
    <div className="p-8">
