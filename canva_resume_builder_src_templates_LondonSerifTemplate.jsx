...
export const LondonSerifTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden font-serif italic p-16 border-y-4 border-black">
    <div className="p-8">
