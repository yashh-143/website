...
export const MinExecTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden font-serif text-center py-24 px-20">
    <div className="p-8">
