...
export const AcademicTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden text-[9pt] leading-tight p-10 font-serif">
    <div className="p-8">
