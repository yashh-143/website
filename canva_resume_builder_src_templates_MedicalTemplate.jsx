...
export const MedicalTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden bg-[#f8fafc] p-10 border-t-8 border-sky-600">
    <div className="p-8">
