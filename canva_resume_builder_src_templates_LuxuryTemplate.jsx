...
export const LuxuryTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden bg-[#fafaf9] border border-[#d6d3d1] p-12">
    <div className="p-8">
