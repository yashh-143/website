...
export const SoftUITemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden bg-slate-50 p-8 flex rounded-[40px]">
    <div className="p-8">
