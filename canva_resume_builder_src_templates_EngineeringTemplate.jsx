...
export const EngineeringTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden bg-[#1e1e1e] text-[#d4d4d4] font-mono p-8 text-xs">
    <div className="p-8">
