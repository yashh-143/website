...
export const ExecutiveTemplate = ({ data, reference }) => (
  <div ref={reference} className="bg-white shadow-2xl min-h-[1123px] w-[794px] mx-auto overflow-hidden border-[12px] border-slate-50 p-12">
    <div className="p-8">
